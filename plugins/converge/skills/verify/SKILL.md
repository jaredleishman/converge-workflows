...
1. Resolve the exact candidate: PR base/head, commit range, or local worktree
   fingerprint. Record it in `state.yaml`.
...
7. End with `INTERNALLY_VERIFIED`, `REPLAN`, `SPLIT`, or `BLOCKED`.
